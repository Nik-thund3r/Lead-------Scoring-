...
Solution:
To improve lead conversion rates, X Education aims to identify and prioritize the most potential leads, known as 'Hot Leads.' By focusing efforts on communicating with these high-potential leads, the company expects to increase the lead conversion rate from the current 30% to around 80%. The following steps will be undertaken in this case study:
...
5. Feature scaling
6. Correlations
7. Model Building (RFE Rsquared VIF and p- values)
8. Model Evaluation
